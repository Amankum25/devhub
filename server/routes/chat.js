...
router.get('/rooms/:roomId/messages', validationRules.withRoomId, catchAsync(async (req, res) => {
...
router.post('/rooms/:roomId/messages', validationRules.sendMessage, catchAsync(async (req, res) => {
  const { roomId } = req.params;
...
// Create new room
router.post('/rooms', validationRules.createRoom, catchAsync(async (req, res) => {
