...
const commonValidations = {
  ...
  postSlug: body('slug')
    ...
    .matches(/^[a-z0-9-]+$/)
    .withMessage('Slug must be 3-100 characters and contain only lowercase letters, numbers, and hyphens'),
  ...
  snippetTitle: body('title')
    ...
    .withMessage('Snippet title is required and must be less than 100 characters'),
  ...
  aiTool: body('tool')
    .isIn(['code_explain', 'project_suggest', 'resume_review', 'code_generate', 'debug_help'])
...
const validationRules = {
  ...
  changePassword: [
    ...
    commonValidations.password.withMessage('New password must be at least 6 characters long and contain uppercase, lowercase, and number'),
    validateRequest
  ],
  ...
  createComment: [
    ...
    param('parentId').optional().isInt({ min: 1 }).withMessage('Parent comment ID must be a positive integer'),
    validateRequest
  ],
  ...
  createRoom: [
    ...
    body('type').optional().isIn(['public', 'private']).withMessage('Room type must be public or private'),
    validateRequest
  ],
