    ...
    general: [
      {
        ...
        message:
          "Hey everyone! Working on a new React project, any tips for state management?",
        time: "10:30 AM",
        isOwn: false,
      },
      {
        ...
        avatar: "/placeholder.svg",
        message:
          "For React 18, I'd recommend using Zustand or the built-in useReducer for complex state",
        time: "10:32 AM",
        isOwn: false,
      },
      {
        ...
        avatar: "/placeholder.svg",
        message:
          "Thanks! I'll check out Zustand. Has anyone used it in production?",
        time: "10:35 AM",
        isOwn: true,
      },
      {
        ...
        avatar: "/placeholder.svg",
        message:
          "Yes! We've been using Zustand for 6 months now. Much cleaner than Redux for our use case",
        time: "10:37 AM",
        isOwn: false,
      },
      {
        ...
        avatar: "/placeholder.svg",
        message:
          "Just remember to use devtools middleware for debugging. Makes development much easier!",
        time: "10:39 AM",
        isOwn: false,
      },
    ],
    "react-help": [
      {
        ...
        user: "Emma Wilson",
        avatar: "/placeholder.svg",
        message: "Can someone help me with React 18 concurrent features?",
        time: "9:15 AM",
        isOwn: false,
      },
      {
        ...
        user: "Frank Miller",
        avatar: "/placeholder.svg",
        message: "Sure! What specifically are you trying to implement?",
        time: "9:17 AM",
        isOwn: false,
      },
      {
        ...
        user: "You",
        avatar: "/placeholder.svg",
        message: "I'm also interested in this. Are you using Suspense?",
        time: "9:20 AM",
        isOwn: true,
      },
    ],
    "js-tips": [
      {
        ...
        avatar: "/placeholder.svg",
        message:
          "Quick tip: Use optional chaining (?.) to avoid null reference errors",
        time: "8:45 AM",
        isOwn: false,
      },
      {
        ...
        avatar: "/placeholder.svg",
        message:
          "That saved me so many try-catch blocks! ES2020 features are amazing",
        time: "8:47 AM",
        isOwn: false,
      },
    ],
                  ...
                  >
                    ...
                    <div className="flex items-center space-x-1 flex-shrink-0">
                      {room.unread > 0 && (
                        <Badge
                          variant="secondary"
                          className="bg-red-500 text-white text-xs px-1.5 py-0.5 min-w-[1.25rem] h-5"
                        >
                          {room.unread}
                        </Badge>
                      )}
              ...
              <div className="space-y-2">
                {onlineUsers.slice(0, 8).map((user, index) => (
                  ...
                  >
                    ...
                    <span
                      className={`truncate ${user.status === "online" ? "text-gray-900" : "text-gray-500"}`}
                    >
                      {user.name}
                    </span>
                  </div>
          ...
          <ScrollArea className="flex-1 p-4">
            <div className="space-y-4">
              {currentMessages.map((msg) => (
                ...
                >
                  <div
                    className={`flex space-x-3 max-w-[70%] ${msg.isOwn ? "flex-row-reverse space-x-reverse" : ""}`}
                  >
                    ...
                    <div
                      className={`space-y-1 ${msg.isOwn ? "text-right" : ""}`}
                    >
                      <div className="flex items-center space-x-2">
                        <span
                          className={`text-sm font-medium ${msg.isOwn ? "text-blue-600" : "text-gray-900"}`}
                        >
                          {msg.user}
                        </span>
