...
export default function AITools() {
  ...
  const aiTools = [
    ...
    },
    {
      ...
      features: ["ATS optimization", "Technical skills analysis", "Industry insights"],
      popular: false,
      usageCount: 892,
    },
    {
      ...
      description: "Discover personalized project ideas to enhance your portfolio and skills",
      icon: Lightbulb,
      color: "bg-purple-500",
      gradient: "from-purple-500 to-purple-600",
      href: "/ai/project-suggest",
      features: ["Skill-based matching", "Difficulty levels", "Tech stack recommendations"],
      popular: true,
      usageCount: 756,
    },
    {
      ...
      description: "Generate boilerplate code and templates for various programming tasks",
      icon: Wrench,
      color: "bg-orange-500",
      gradient: "from-orange-500 to-orange-600",
      href: "/ai/code-generate",
      features: ["Multiple languages", "Framework templates", "Custom patterns"],
      popular: false,
      usageCount: 634,
    },
    {
      id: "bug-fix",
      title: "Bug Fixer",
      description: "Identify and fix common bugs in your code with AI assistance",
      icon: Target,
      color: "bg-red-500",
      gradient: "from-red-500 to-red-600",
      href: "/ai/bug-fix",
      features: ["Error detection", "Fix suggestions", "Prevention tips"],
      popular: false,
      usageCount: 423,
    },
    {
      ...
      features: ["Visual explanations", "Complexity analysis", "Practice problems"],
      popular: false,
      usageCount: 389,
    },
  ];
