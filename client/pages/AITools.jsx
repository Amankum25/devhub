  ...
  const aiTools = [
    {
      ...
      features: ['Multi-language support', 'Line-by-line breakdown', 'Best practices tips'],
      popular: true,
      usageCount: 1245
    },
    {
      ...
      features: ['ATS optimization', 'Industry-specific tips', 'Skill gap analysis'],
      popular: false,
      usageCount: 892
    },
    {
    ...
    },
    {
      ...
      features: ['Skill-based matching', 'Difficulty levels', 'Resource recommendations'],
      popular: false,
      usageCount: 634
    },
    {
      ...
      features: ['Natural language input', 'Multiple frameworks', 'Clean, readable code'],
      popular: true,
      usageCount: 1089
    },
    {
      ...
      features: ['Visual explanations', 'Time complexity analysis', 'Practice problems'],
      popular: false,
      usageCount: 445
    }
  ];
      ...
      <div className="max-w-7xl mx-auto space-y-8">
        ...
        <div className="text-center space-y-4">
          ...
          <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
            Supercharge your development workflow with intelligent AI assistants designed specifically for developers
          </p>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Your latest AI assistant usage
              </CardDescription>
            </CardHeader>
            <CardContent>
              <div className="space-y-4">
                {recentPrompts.map((prompt) => (
                  <div key={prompt.id} className="flex items-start space-x-3 p-3 rounded-lg hover:bg-muted/50 transition-colors">
                    <div className="w-2 h-2 rounded-full bg-green-500 mt-2"></div>
                    <div className="flex-1 space-y-1">
                      <div className="flex items-center justify-between">
                        <p className="text-sm font-medium">{prompt.tool}</p>
                        <span className="text-xs text-muted-foreground">{prompt.time}</span>
                      </div>
              ...
              <div className="space-y-4">
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-muted-foreground">Select the AI tool that matches your current need</p>
                  </div>
                </div>
                ...
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-muted-foreground">Be specific about what you want the AI to help with</p>
                  </div>
                </div>
                ...
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-muted-foreground">Receive AI-powered suggestions and explanations</p>
                  </div>
                </div>
                ...
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-muted-foreground">Use the insights to improve your development skills</p>
                  </div>
                </div>
              </div>
        ...
        <Card className="bg-gradient-to-r from-primary/5 to-accent/5">
          <CardContent className="p-6">
            <div className="flex items-start space-x-4">
              ...
              <div>
                <h3 className="text-lg font-semibold mb-2">Pro Tips for Better AI Interactions</h3>
                <ul className="space-y-2 text-sm text-muted-foreground">
                  <li>• Be specific about the programming language and framework you're using</li>
                  <li>• Include relevant context like error messages or expected behavior</li>
                  <li>• Ask follow-up questions to dive deeper into complex topics</li>
                  <li>• Use the AI suggestions as learning opportunities, not just quick fixes</li>
                </ul>
              </div>
            </div>
          </CardContent>
