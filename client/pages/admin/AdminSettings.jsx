      ...
      settings: [
        {
          id: "ai_tools",
          label: "AI Tools",
          description: "Enable AI-powered development tools",
          enabled: true,
        },
        {
          id: "real_time_chat",
        ...
        },
        {
          id: "code_snippets",
          label: "Code Snippets",
          description: "Allow users to share code snippets",
          enabled: true,
        },
        {
          id: "blog_posts",
          label: "Blog Posts",
          description: "Enable blog posting functionality",
          enabled: true,
        },
      ],
    },
    {
      ...
      settings: [
        ...
        },
        {
          ...
          description: "Alert admins about content requiring moderation",
          enabled: true,
        },
      ],
    },
      ...
      <div className="flex justify-between items-start">
        <div>
          ...
          <p className="text-gray-600 mt-2">
            Configure global platform features and security
          </p>
        </div>
        <Button>
